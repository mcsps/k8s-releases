...
- Bundle pruning became too aggressive in Rancher Manager 2.6.7. This has been fixed. Update to 2.6.8 or later to prevent potential data loss. See [the fix](https://github.com/rancher/fleet/pull/933) for more details.
